...
globalkeys = gears.table.join(
    ...
    end, { description = "interactive screenshot", group = "screenshots" }),
    -- awful.key({ "Shift", "Mod4"   }, "S",
    --           function () awful.util.spawn("gnome-screenshot -ca") end,
    --           {description = "area screenshot to clipboard", group = "screenshots"}),
