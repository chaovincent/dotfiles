...
globalkeys = gears.table.join(
    ...
    -- Swap/Move windows by direction
    -- Swap/Move windows by direction using Capital HJKL
    awful.key({ modkey, "Shift" }, "h", function () if client.focus then awful.client.swap.bydirection("left", client.focus) end end,
              {description = "swap left", group = "client"}),
    awful.key({ modkey, "Shift" }, "j", function () if client.focus then awful.client.swap.bydirection("down", client.focus) end end,
              {description = "swap down", group = "client"}),
    awful.key({ modkey, "Shift" }, "k", function () if client.focus then awful.client.swap.bydirection("up", client.focus) end end,
              {description = "swap up", group = "client"}),
    awful.key({ modkey, "Shift" }, "l", function () if client.focus then awful.client.swap.bydirection("right", client.focus) end end,
